...
/**
 * <p>Classe Java de coleta complex type.</p>
 * 
...
public class Coleta {
     ...
     * This is why there is not a <CODE>set</CODE> method for the documento property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the produto property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
